          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:Arial,sans-serif;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:30px;background-color:#f7d63c;">
                <h1 style="margin-top:0;margin-bottom:16px;font-size:30px;line-height:32px;font-weight:800;letter-spacing:-0.02em; color: #000;">Purchase Confirmation</h1>
            ...
            <tr>
              <td style="padding:35px 30px 11px 30px;font-size:0;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                  <p style="font-size: 25px; font-weight:700; color:#ff3884; line-height: 37px;">Congraulation, Your payment successfull recived. Futher we will contact you</p>
              </td>
            </tr>
            <tr>
              <td style="padding:10px 30px 11px 30px;font-size:0;background-color:#ffffff;border-bottom:1px solid #f0f0f5;border-color:rgba(201,201,207,.35);">
                    ...
                    <p style="font-size: 25px; font-weight:700">Order Id: #{{$fetch_order->id}}</p>
                    <p style="font-size: 25px; font-weight:700">Transaction ID: {{$fetch_order->transaction}}</p>
                    <p style="font-size: 25px; font-weight:700">Payment Type: {{$fetch_order->payment_type}}</p>
                    <p style="font-size: 25px; font-weight:700">Billing Phone Number: {{$fetch_order->phone}}</p>
                    <p style="font-size: 25px; font-weight:700">Regarding Any issues please call the number</p>
